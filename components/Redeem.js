...
const Redeem = () => {
  return (
   ...
   <div className='w-screen relative h-72 mt-12 flex items-center justify-center'>
    <div className='z-10 absolute flex items-center justify-center p-3 rounded-xl bg-green-500 text-white font-bold text-3xl cursor-pointer'><Link href="/voucher">Redeem Coins</Link></div>
